...
namespace SVGCreationExample
{
    public class Function
    {
        ...
        private IModelStore<SVGCreationExampleInputs> store;

        public async Task<SVGCreationExampleOutputs> Handler(SVGCreationExampleInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<SVGCreationExampleInputs>(RegionEndpoint.USWest1);
            }

            var l = new InvocationWrapper<SVGCreationExampleInputs,SVGCreationExampleOutputs>(store, SVGCreationExample.Execute);
